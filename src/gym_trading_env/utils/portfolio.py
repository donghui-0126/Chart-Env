class Portfolio:
    ...
    def trade_to_position(self, position, price, trading_fees, is_execute):
        # Repay interest
    ...
    def update_interest(self, asset_borrow_interest_rate, piat_borrow_interest_rate):
        ...
        self.interest_fiat = max(0, -self.fiat) * piat_borrow_interest_rate
